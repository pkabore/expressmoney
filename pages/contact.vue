    ...
    <div class="hero-body">
      <div class="container">
        <div class="columns">
          ...
          <div class="column">
            <div class="box is-flex is-fullheight is-flex-direction-column">
              <h2 class="title has-text-centered has-text-dark">
                <b-icon icon="phone-alt" class="circular-sui" size="is-large"></b-icon>&nbsp;Nos contacts
              </h2>
              <div class="mt-4">
                <ul class="mt-2 mx-3 has-text-dark has-text-centered">
                  <li class="has-text-centered my-3 is-size-4 has-text-dark">
